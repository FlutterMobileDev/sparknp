            ...
            children: [
              ...
              Column(
                children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border:
                                Border.all(width: 1.5, color: LightColor.primaryColor)
                            ),
                  ...
                  (searchString != '' && searchString != null)?Container(
                    height: size.height,
                    width: size.width,
                        ...
                        return (snapshot.connectionState == ConnectionState.waiting)?Center(
                          child: CircularProgressIndicator(),
                            ...
                            itemBuilder:(context, index){
                              dynamic product = snapshot.data.products[index];
                                ...
                                child: Container(
                                  ...
                                  child: Card(
                                    child: ListTile(
                                      ...
                                      leading: Image.network(imgpath+ product.thumbnail,fit: BoxFit.cover,),
                                    ),
                                  ),
                                ),
                              );
